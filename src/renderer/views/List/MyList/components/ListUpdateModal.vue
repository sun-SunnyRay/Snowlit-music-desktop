...
import { isAccountAutoListId } from '@renderer/store/sourceAccount'
...
export default {
  ...
  setup() {
    const lists = computed(() => userLists.filter(l => !!l.source && !!musicSdk[l.source]?.songList && !isAccountAutoListId(l.id)))
